...
//                String addr = "F8:95:C7:04:E5:B5"; // LG 1st
//            addr = "5C:70:A3:F2:12:62"; // LG 2nd
//            addr = "40:4E:36:D9:EC:CF"; // pixel
//            addr = "64:BC:0C:E7:42:1C"; // Nexus 5X kratos
...
//                }
    ...
    public class connectPeerSide extends Thread{
        ...
        public void run() {
            try {
                // read remote BT address from config
//                File f = new File("/storage/emulated/0/dmm/bt_config.txt");
//                Scanner sc = new Scanner(f);
////            //log.d(TAG, sc.nextLine() + "GO");
//                String addr = sc.nextLine();
                String addr = "F8:95:C7:04:E5:B5"; // LG 1st
//            addr = "5C:70:A3:F2:12:62"; // LG 2nd
//            addr = "40:4E:36:D9:EC:CF"; // pixel
//            addr = "64:BC:0C:E7:42:1C"; // Nexus 5X kratos
                remoteDevice = myAdapter.getRemoteDevice(addr); //connect to wearable
    ...
    public void sendDataToBT() {
        try{
            ...
            Log.d(TAG, "Ready to sendDataToBT");
            while(true){
    ...
    public void sendDataToBTSide(){
        ...
        //todo: once receive the RTT, send back
    }
    ...
    public void recvDataFromBT(){
        try {
            ...
            int bytesRead;
            int sumRead = 0;
            Log.d(TAG, "Ready to recvDataFromBT");
            while (true) {
